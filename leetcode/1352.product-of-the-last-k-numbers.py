...
ProductOfNumbers=type('',(list,),{'__init__':lambda s:list.__init__(s,[1]),'add':lambda s,x:s.__init__()if x<1 else s.append(s[-1]*x),'getProduct':lambda s,k:k<len(s)and s[-1]//s[~k]or 0})

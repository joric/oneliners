...
Rotating string "ABCDEFGH" by k=3 characters left (n is string length, reverse arguments are start and end position):

```c
reverse(0, k-1)    /* CBADEFGH */
reverse(k, n-1)    /* CBAHGFED */

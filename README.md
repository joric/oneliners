...
* You can use `~~()` instead of `int()`, akin to js (1 character shorter) for booleans (you can also prepend with a single `+`).
...
* A check like `x&(x-1)<1` determines if unsigned integer is power of 2 or 0 (turns off the rightmost bit).

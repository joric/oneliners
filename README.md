...
Brings computation complexity from exponential to quadratic or linear, depending of the problem. Essentially, a built-in memoization.
You can also easily implement a [CPP version](https://gist.github.com/joric/ed96c06c2e5440e0cbf84b3ff78f3a12) of a cache decorator.
...
You can write combination function (binomial) `n*(n-1)//2` as `comb(n,2)`, or you can write `(n-1)` as `~-n` to cut parens.

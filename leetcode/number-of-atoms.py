...
class Solution:
    def countOfAtoms(self, a: str) -> str:
        d,q,k,e,t,i = defaultdict(int),[],1,'',0,0
        for c in a[::-1]:
            def f(c,k,e,t,i):
                if c == ')':
                    return q.append(t or 1)or(k*(t or 1),e,0,0)
                elif c == '(':
                    return k//q.pop(),e,0,0
                elif c.isupper():
                    return setitem(d,w:=(e+c)[::-1],d[w]+(t or 1)*k)or(k,'',0,0)
                elif c.isdigit():
                    return k,e,t+int(c)*10**i,i+1
                elif c.islower():
                    return k,e+c,t,i
                return k,e,t,i
            k,e,t,i = f(c,k,e,t,i)

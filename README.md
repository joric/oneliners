...
It's not necessarily shorter, because lambdas can't use semicolons. Let's consider a function declaration is zero lines.
...
May be useful, e.g. this would not work without converting a string to an iterator:
